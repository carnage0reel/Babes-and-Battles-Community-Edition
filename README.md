...
# 🎮 Babes and Battles — Community Edition

**Turn-based tactical battles in a standalone Community Edition**
...
Babes and Battles is a turn-based strategy game featuring squad-based tactical combat, character recruitment, and arena skirmishes across a stylized campaign. This Community Edition is a standalone build delivered as a self-contained package that runs fully offline. It includes all content, requires no storefront and no additional software, and is ready to play immediately after installation.

Players who want a complete, self-contained version of Babes and Battles for offline and LAN play.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4734530/0e5234993d39d0600071ed0a2f8d4bbdb188c9bf/ss_0e5234993d39d0600071ed0a2f8d4bbdb188c9bf.1920x1080.jpg?t=1789041136" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4734530/79dd166d0fa2a71b2c60bedc9da806c789546668/ss_79dd166d0fa2a71b2c60bedc9da806c789546668.1920x1080.jpg?t=1789041136" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4734530/36502d00987d1f1f6bdfa20fff28053de6df054e/ss_36502d00987d1f1f6bdfa20fff28053de6df054e.1920x1080.jpg?t=1789041136" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- ⚔️ **Turn-Based Combat** — Grid-based tactical battles with unit positioning, counters, and ability combos.
- 👥 **Character Roster** — Recruit, level, and equip dozens of distinct fighters.
- 🗺️ **Campaign Mode** — Story missions spanning varied arenas and escalating encounters.
- 🏟️ **Arena Skirmishes** — Quick-match battles against AI opponents with adjustable difficulty.
- 🌐 **LAN Multiplayer** — LAN and direct connection supported for head-to-head matches.
- 💻 **Fully Offline** — The complete game runs without an internet connection.
- 🎨 **Stylized Artwork** — Hand-drawn portraits, animations, and battle effects.
- 🔊 **Full Soundtrack** — Original score and battle themes included in the package.

- **Compression:** Lossless
- **Install Time:** ~3 minutes on SSD, ~8 minutes on HDD
- **Recoding:** none
- **Selective Download:** None — single self-contained archive
...
| **RAM** | 4 GB | 8 GB |
| **Graphics** | NVIDIA GeForce GTX 650 or AMD Radeon HD 7750, 2 GB VRAM | NVIDIA GeForce GTX 1050 Ti or AMD Radeon RX 560, 4 GB VRAM |
| **Storage** | 4 GB available space | 4 GB available space (SSD) |
| **Additional** | DirectX 11, keyboard and mouse | DirectX 11, keyboard and mouse, audio output device |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\BabesandBattles\Saved`
